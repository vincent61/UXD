...
// Temps de compilation total: 6.503 ms
//

function html_83f901399b70378d1109c68398198656($Cache, $Pile, $doublons=array(), $Numrows=array(), $SP=0) {
...
(($t1 = strval(interdire_scripts(entites_html(table_valeur(@$Pile[0], (string)'editable', null),true))))!=='' ?
	...
	'</div><ul>
			' .
	vide($Pile['vars'][(string)'name'] = 'documents_objets') .
	...
	'exclus' => 'spip_documents' ), array('compil'=>array('../plugins-dist/medias/formulaires/configurer_documents.html','html_83f901399b70378d1109c68398198656','',14,$GLOBALS['spip_lang'])), '') .
	'</li>
			' .
	vide($Pile['vars'][(string)'name'] = 'documents_date') .
	vide($Pile['vars'][(string)'erreurs'] = table_valeur(table_valeur(@$Pile[0], (string)'erreurs', null),table_valeur($Pile["vars"], (string)'name', null))) .
...
'
	...
	return analyse_resultat_skel('html_83f901399b70378d1109c68398198656', $Cache, $page, '../plugins-dist/medias/formulaires/configurer_documents.html');
}
?>