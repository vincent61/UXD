...
// Temps de compilation total: 3.769 ms
//

function html_4ccc49f4d182cd56e8e33151b228e205($Cache, $Pile, $doublons=array(), $Numrows=array(), $SP=0) {
...
(($t1 = strval(interdire_scripts(entites_html(table_valeur(@$Pile[0], (string)'editable', null),true))))!=='' ?
	...
	'
	  	...
	  	' .
	vide($Pile['vars'][(string)'name'] = 'changer_langue_site') .
...
'
	...
	return analyse_resultat_skel('html_4ccc49f4d182cd56e8e33151b228e205', $Cache, $page, '../prive/formulaires/configurer_langue.html');
}
?>