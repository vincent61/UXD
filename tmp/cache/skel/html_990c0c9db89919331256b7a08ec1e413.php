 ...
 * Date :      Sat, 27 Apr 2013 18:45:00 GMT
 * Compile :   Wed, 08 May 2013 10:05:48 GMT
 * Boucles :   _art
 */ 
...
'
' .
vide($Pile['vars'][(string)'auteurs'] = recuperer_fond('modeles/lesauteurs', array('objet'=>'article','id_objet' => $Pile[$SP]['id_article'],'id_article' => $Pile[$SP]['id_article']), array('trim'=>true, 'compil'=>array('notifications/article_publie.html','html_990c0c9db89919331256b7a08ec1e413','_art',0,$GLOBALS['spip_lang'])), '')) .
...
// Temps de compilation total: 10.994 ms
//
