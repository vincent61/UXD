 ...
 * Compile :   Wed, 08 May 2013 12:43:04 GMT
...
(($t1 = strval(interdire_scripts(((match($Pile[$SP]['extension'],'gif|png|jpg')) ?' ' :''))))!=='' ?
		($t1 . (	' ' .
	vide($Pile['vars'][(string)'id'] = ($Pile[$SP]['id_vignette'] ? $Pile[$SP]['id_vignette']:$Pile[$SP]['id_document'])) .
	'<div class="tourner">
			' .
...
. (	'
			' .
	(((($Numrows['_compte']['total'] == '1')) AND (invalideur_session($Cache, ((function_exists("autoriser")||include_spip("inc/autoriser"))&&autoriser('modifier', interdire_scripts(invalideur_session($Cache, $Pile[$SP]['objet'])), invalideur_session($Cache, $Pile[$SP]['id_objet']))?" ":""))))  ?
...
// Temps de compilation total: 47.754 ms
//
