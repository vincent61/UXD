 ...
 * Date :      Sat, 27 Apr 2013 18:44:48 GMT
 * Compile :   Wed, 08 May 2013 13:37:19 GMT
 * Boucles :   
 */ 
//
// Fonction principale du squelette ../prive/formulaires/editer_auteur.html
// Temps de compilation total: 14.690 ms
//

function html_7b437a8368e6ad78a53a355bf24b4099($Cache, $Pile, $doublons=array(), $Numrows=array(), $SP=0) {
...
(($t1 = strval(interdire_scripts(entites_html(table_valeur(@$Pile[0], (string)'editable', null),true))))!=='' ?
	...
	'
		<ul>
			<li class="editer editer_nom obligatoire' .
	...
	(($t2 = strval(invalideur_session($Cache, ((((function_exists("autoriser")||include_spip("inc/autoriser"))&&autoriser('modifier', 'auteur', invalideur_session($Cache, @$Pile[0]['id_auteur']), '', invalideur_session($Cache, array('statut' => '?')))?" ":"")) ?' ' :''))))!=='' ?
			...
			<li class=\'editer editer_statut\'>
				' .
		recuperer_fond( 'formulaires/inc-instituer_auteur' , array('statut' => sinon(table_valeur(@$Pile[0], (string)'statut', null), interdire_scripts(eval('return '.'_STATUT_AUTEUR_CREATION'.';'))) ,
	'id_auteur' => @$Pile[0]['id_auteur'] ,
	'webmestre' => @$Pile[0]['webmestre'] ), array('compil'=>array('../prive/formulaires/editer_auteur.html','html_7b437a8368e6ad78a53a355bf24b4099','',31,$GLOBALS['spip_lang'])), '') .
		'</li>')) :
			'') .
	'
			' .
	...
	'
					...
					' .
	'
					<li class=\'editer editer_new_login' .
	...
	(($t2 = strval(interdire_scripts(((table_valeur(entites_html(table_valeur(@$Pile[0], (string)'config', null),true),'edit_pass')) ?' ' :''))))!=='' ?
			($t2 . (	'
					<li class=\'editer editer_new_pass' .
...
'
	...
	return analyse_resultat_skel('html_7b437a8368e6ad78a53a355bf24b4099', $Cache, $page, '../prive/formulaires/editer_auteur.html');
}
?>