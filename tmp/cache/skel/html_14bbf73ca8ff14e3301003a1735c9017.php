...
// Temps de compilation total: 18.530 ms
//
...
'<'.'?php echo recuperer_fond( ' . argumenter_squelette('inclure/head') . ', array(\'lang\' => ' . argumenter_squelette($GLOBALS["spip_lang"]) . '), array("compil"=>array(\'squelettes-dist/404.html\',\'html_14bbf73ca8ff14e3301003a1735c9017\',\'\',13,$GLOBALS[\'spip_lang\'])), _request("connect"));
?'.'>
...
'<'.'?php echo recuperer_fond( ' . argumenter_squelette('inclure/header') . ', array(\'lang\' => ' . argumenter_squelette($GLOBALS["spip_lang"]) . '), array("compil"=>array(\'squelettes-dist/404.html\',\'html_14bbf73ca8ff14e3301003a1735c9017\',\'\',19,$GLOBALS[\'spip_lang\'])), _request("connect"));
?'.'>
	' .

'<'.'?php echo recuperer_fond( ' . argumenter_squelette('inclure/nav') . ', array_merge('.var_export($Pile[0],1).',array(\'lang\' => ' . argumenter_squelette($GLOBALS["spip_lang"]) . ')), array("compil"=>array(\'squelettes-dist/404.html\',\'html_14bbf73ca8ff14e3301003a1735c9017\',\'\',20,$GLOBALS[\'spip_lang\'])), _request("connect"));
?'.'>
...
'<'.'?php echo recuperer_fond( ' . argumenter_squelette('inclure/navsub') . ', array(\'lang\' => ' . argumenter_squelette($GLOBALS["spip_lang"]) . '), array("compil"=>array(\'squelettes-dist/404.html\',\'html_14bbf73ca8ff14e3301003a1735c9017\',\'\',37,$GLOBALS[\'spip_lang\'])), _request("connect"));
?'.'>
			' .
executer_balise_dynamique('FORMULAIRE_RECHERCHE',
	array(),
	array('squelettes-dist/404.html','html_14bbf73ca8ff14e3301003a1735c9017','',38,$GLOBALS['spip_lang'])) .
'
		</div><!--.aside-->
	</div><!--.main-->
...
'<'.'?php echo recuperer_fond( ' . argumenter_squelette('inclure/footer') . ', array_merge('.var_export($Pile[0],1).',array(\'self\' => ' . argumenter_squelette(self()) . ',
	\'lang\' => ' . argumenter_squelette($GLOBALS["spip_lang"]) . ')), array("compil"=>array(\'squelettes-dist/404.html\',\'html_14bbf73ca8ff14e3301003a1735c9017\',\'\',42,$GLOBALS[\'spip_lang\'])), _request("connect"));
?'.'>
...
');
	...
	return analyse_resultat_skel('html_14bbf73ca8ff14e3301003a1735c9017', $Cache, $page, 'squelettes-dist/404.html');
}
?>