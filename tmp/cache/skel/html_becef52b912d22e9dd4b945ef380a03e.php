...
function BOUCLE_dochtml_becef52b912d22e9dd4b945ef380a03e(&$Cache, &$Pile, &$doublons, &$Numrows, $SP) {
...
quete_condition_postdates('documents.date_publication',''), 
	...
	$iter = IterFactory::create(
		"SQL",
		$command,
		array('squelettes-dist/inclure/forum.html','html_becef52b912d22e9dd4b945ef380a03e','_doc',25,$GLOBALS['spip_lang'])
	);
	if (!$iter->err()) {
	$SP++;
	// RESULTATS
...
interdire_scripts((match($Pile[$SP]['extension'],'^(gif|jpg|png)$') ? (	filtrer('image_graver',filtrer('image_reduire',
	...
	recuperer_fond('modeles/emb', array('lang' => $GLOBALS["spip_lang"] ,'id_document'=>$Pile[$SP]['id_document'],'id'=>$Pile[$SP]['id_document'],'recurs'=>(++$recurs)), array('compil'=>array('squelettes-dist/inclure/forum.html','html_becef52b912d22e9dd4b945ef380a03e','_doc',27,$GLOBALS['spip_lang']), 'trim'=>true), ''))
,'500','*')) .
	'
...
function BOUCLE_doc2html_becef52b912d22e9dd4b945ef380a03e(&$Cache, &$Pile, &$doublons, &$Numrows, $SP) {
...
quete_condition_postdates('documents.date_publication',''), 
	...
	$iter = IterFactory::create(
		"SQL",
		$command,
		array('squelettes-dist/inclure/forum.html','html_becef52b912d22e9dd4b945ef380a03e','_doc2',50,$GLOBALS['spip_lang'])
	);
	if (!$iter->err()) {
	$SP++;
	// RESULTATS
...
interdire_scripts((match($Pile[$SP]['extension'],'^(gif|jpg|png)$') ? (	filtrer('image_graver',filtrer('image_reduire',
	((($recurs=(isset($Pile[0]['recurs'])?$Pile[0]['recurs']:0))>=5)? '' :
	recuperer_fond('modeles/emb', array('lang' => $GLOBALS["spip_lang"] ,'id_document'=>$Pile[$SP]['id_document'],'id'=>$Pile[$SP]['id_document'],'recurs'=>(++$recurs)), array('compil'=>array('squelettes-dist/inclure/forum.html','html_becef52b912d22e9dd4b945ef380a03e','_doc2',52,$GLOBALS['spip_lang']), 'trim'=>true), ''))
,'500','*')) .
	'
						'):quete_logo_document(quete_document($Pile[$SP]['id_document'], ''), vider_url(urlencode_1738(generer_url_entite($Pile[$SP]['id_document'], 'document', '', '', true))), '', '', 0, 0, ''))) .
'
...
function BOUCLE_comments_filshtml_becef52b912d22e9dd4b945ef380a03e(&$Cache, &$Pile, &$doublons, &$Numrows, $SP) {
...
quete_condition_statut('forum.statut','publie,prop','publie',''), 
	...
	$iter = IterFactory::create(
		"SQL",
		$command,
		array('squelettes-dist/inclure/forum.html','html_becef52b912d22e9dd4b945ef380a03e','_comments-fils',34,$GLOBALS['spip_lang'])
	);
	if (!$iter->err()) {
...
(($t1 = strval(interdire_scripts(((((include_spip('inc/config')?lire_config('forums_titre',null,false):'') != 'non')) ?' ' :''))))!=='' ?
	...
	(($t2 = strval(interdire_scripts(safehtml(typo(interdit_html($Pile[$SP]['titre']), "TYPO", $connect, $Pile[0])))))!=='' ?
			($t2 . ', ') :
			'') .
	'</strong>')) :
		'') .
...
'
						' .
(($t1 = BOUCLE_doc2html_becef52b912d22e9dd4b945ef380a03e($Cache, $Pile, $doublons, $Numrows, $SP))!=='' ?
...
function BOUCLE_commentshtml_becef52b912d22e9dd4b945ef380a03e(&$Cache, &$Pile, &$doublons, &$Numrows, $SP) {
...
quete_condition_statut('forum.statut','publie,prop','publie',''), 
	...
	$iter = IterFactory::create(
		"SQL",
		$command,
		array('squelettes-dist/inclure/forum.html','html_becef52b912d22e9dd4b945ef380a03e','_comments',6,$GLOBALS['spip_lang'])
	);
	if (!$iter->err()) {
...
'
				' .
(($t1 = BOUCLE_dochtml_becef52b912d22e9dd4b945ef380a03e($Cache, $Pile, $doublons, $Numrows, $SP))!=='' ?
		('<div class="comment-doc">' . $t1 . '</div>') :
		'') .
'
			</div>
		...
		' .
(($t1 = BOUCLE_comments_filshtml_becef52b912d22e9dd4b945ef380a03e($Cache, $Pile, $doublons, $Numrows, $SP))!=='' ?
		('
...
// Temps de compilation total: 20.914 ms
//

function html_becef52b912d22e9dd4b945ef380a03e($Cache, $Pile, $doublons=array(), $Numrows=array(), $SP=0) {
...
' .
(($t1 = BOUCLE_commentshtml_becef52b912d22e9dd4b945ef380a03e($Cache, $Pile, $doublons, $Numrows, $SP))!=='' ?
		((	'
...
');
	...
	return analyse_resultat_skel('html_becef52b912d22e9dd4b945ef380a03e', $Cache, $page, 'squelettes-dist/inclure/forum.html');
}
?>